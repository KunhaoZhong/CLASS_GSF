...
struct background
{
  ...
  double Omega0_gsf;       /**< \f$ \Omega_{0 gsf} \f$: scalar field */
  double Omega0_gsf2; 
  ...
  double * gsf_parameters; /**< list of parameters describing the scalar field potential */
  short attractor_ic_gsf;  /**< whether the scalar field has attractor initial conditions */
  int gsf_tuning_index;    /**< index in gsf_parameters used for tuning */
  double gsf_dxdy_guess;
  double phi_ini_gsf;      /**< \f$ \phi(t_0) \f$: scalar field initial value */
  double phi_prime_ini_gsf;/**< \f$ d\phi(t_0)/d\tau \f$: scalar field initial derivative wrt conformal time */
  int gsf_parameters_size; /**< size of gsf_parameters */
  ...
  double * gsf2_parameters; /**< list of parameters describing the scalar field potential */
  double ede_p1;
  double ede_p2;
  double f_ede;
  double zc_ede;
  short attractor_ic_gsf2;  /**< whether the scalar field has attractor initial conditions */
  int gsf2_tuning_index;    /**< index in gsf_parameters used for tuning */
  double gsf2_dxdy_guess;
  double phi_ini_gsf2;      /**< \f$ \phi(t_0) \f$: scalar field initial value */
  double phi_prime_ini_gsf2;/**< \f$ d\phi(t_0)/d\tau \f$: scalar field initial derivative wrt conformal time */
  int gsf2_parameters_size; /**< size of gsf_parameters */
  //@}
  ...
  int index_bg_phi_gsf;       /**< scalar field value */
  int index_bg_phi_prime_gsf; /**< scalar field derivative wrt conformal time */
  int index_bg_phi_prime_prime_gsf;
  int index_bg_V_gsf;         /**< scalar field potential V */
  int index_bg_dV_gsf;        /**< scalar field potential derivative V' */
  int index_bg_ddV_gsf;       /**< scalar field potential second derivative V'' */

  int index_bg_phi_gsf2;
  int index_bg_phi_prime_gsf2; /**< scalar field derivative wrt conformal time */
  int index_bg_phi_prime_prime_gsf2;
  int index_bg_V_gsf2;         /**< scalar field potential V */
  int index_bg_dV_gsf2;        /**< scalar field potential derivative V' */
  int index_bg_ddV_gsf2;       /**< scalar field potential second derivative V'' */
  
  //model_gsf is the first number of gsf_parameters
  int index_bg_P_gsf;    //Pressure and it's derivatives
  int index_bg_PX_gsf;   //dP/dX, same below
  int index_bg_Pphi_gsf; 
  int index_bg_PXX_gsf;  
  int index_bg_PXphi_gsf;
  int index_bg_Pphiphi_gsf;  
  int index_bg_PXXX_gsf;
  int index_bg_PXXphi_gsf;
  int index_bg_PXphiphi_gsf;
  int index_bg_A_gsf;
  int index_bg_B_gsf;
  int index_bg_C_dif_gsf;
  int index_bg_D_gsf;
  double ** gsf_in;
  double ** gsf_out;

  int index_bg_P_gsf2;    //Pressure and it's derivatives
  int index_bg_PX_gsf2;   //dP/dX, same below
  int index_bg_Pphi_gsf2; 
  int index_bg_PXX_gsf2;  
  int index_bg_PXphi_gsf2;
  int index_bg_Pphiphi_gsf2;  
  int index_bg_PXXX_gsf2;
  int index_bg_PXXphi_gsf2;
  int index_bg_PXphiphi_gsf2;
  int index_bg_A_gsf2;
  int index_bg_B_gsf2;
  int index_bg_C_dif_gsf2;
  int index_bg_D_gsf2;
  double ** gsf2_in;
  double ** gsf2_out;
  

  int index_bg_rho_gsf;       /**< scalar field energy density */
  int index_bg_p_gsf;         /**< scalar field pressure */
  int index_bg_p_prime_gsf;         /**< scalar field pressure */
  int index_bg_cs2_gsf; 
  int index_bg_w_gsf;

  int index_bg_rho_gsf2;       /**< scalar field energy density */
  int index_bg_p_gsf2;         /**< scalar field pressure */
  int index_bg_p_prime_gsf2;         /**< scalar field pressure */
  int index_bg_cs2_gsf2; 
  int index_bg_w_gsf2;
  ...
  int index_bi_phi_gsf;       /**< {B} scalar field value */
  int index_bi_phi_prime_gsf; /**< {B} scalar field derivative wrt conformal time */
  int index_bi_phi_gsf2;       /**< {B} scalar field value */
  int index_bi_phi_prime_gsf2; /**< {B} scalar field derivative wrt conformal time */
  ...
  short has_gsf;       /**< presence of a scalar field? */
  short has_gsf2;       /**< presence of the second scalar field? */
