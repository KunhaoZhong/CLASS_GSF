...
struct perturbations
{
  ...
  short has_source_delta_gsf;  /**< do we need source for delta from scalar field? */
  short has_source_delta_gsf2;  /**< do we need source for delta from scalar field? */
  ...
  short has_source_theta_gsf;  /**< do we need source for theta of scalar field? */
  short has_source_theta_gsf2;  /**< do we need source for theta of scalar field? */
  ...
  int index_tp_delta_gsf;  /**< index value for delta of scalar field */
  int index_tp_delta_gsf2;  /**< index value for delta of scalar field */
  ...
  int index_tp_theta_gsf;   /**< index value for theta of scalar field */
  int index_tp_theta_gsf2;   /**< index value for theta of scalar field */
...
struct perturbations_vector
{
  ...
  int index_pt_phi_gsf;  /**< scalar field density */
  int index_pt_phi_prime_gsf;  /**< scalar field velocity */
  int index_pt_phi_gsf2;  /**< scalar field density */
  int index_pt_phi_prime_gsf2;  /**< scalar field velocity */
