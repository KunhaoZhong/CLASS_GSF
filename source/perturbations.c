    ...
    for (index_k=0; index_k<ppt->k_size[index_md]; index_k++) {
      ...
      if (output_format == class_format) {
        ...
        if (ppt->has_density_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_delta_gsf],ppt->has_source_delta_gsf,storeidx);
          class_store_double(dataptr,tk[ppt->index_tp_delta_gsf2],ppt->has_source_delta_gsf2,storeidx);
        ...
        if (ppt->has_velocity_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_theta_gsf],ppt->has_source_theta_gsf,storeidx);
          class_store_double(dataptr,tk[ppt->index_tp_theta_gsf2],ppt->has_source_theta_gsf2,storeidx);
...
int perturbations_output_titles(
  ...
  if (output_format == class_format) {
    ...
    if (ppt->has_velocity_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"t_gsf",pba->has_gsf);
      class_store_columntitle(titles,"t_gsf2",pba->has_gsf2);
...
int perturbations_indices(
  ...
  ppt->has_source_delta_gsf = _FALSE_;
  ppt->has_source_delta_gsf2 = _FALSE_;
  ...
  ppt->has_source_theta_gsf = _FALSE_;
  ppt->has_source_theta_gsf2 = _FALSE_;
    ...
    if (_scalars_) {
      ...
      if (ppt->has_density_transfers == _TRUE_) {
        ...
        if (pba->has_gsf == _TRUE_)
          ppt->has_source_delta_gsf = _TRUE_;
        if (pba->has_gsf2 == _TRUE_)
          ppt->has_source_delta_gsf2 = _TRUE_;
        if (pba->has_ur == _TRUE_)
      ...
      if (ppt->has_velocity_transfers == _TRUE_) {
        ...
        if (pba->has_gsf == _TRUE_)
          ppt->has_source_theta_gsf = _TRUE_;
        if (pba->has_gsf2 == _TRUE_)
          ppt->has_source_theta_gsf2 = _TRUE_;
        if (pba->has_ur == _TRUE_)
      ...
      class_define_index(ppt->index_tp_delta_gsf,  ppt->has_source_delta_gsf, index_type,1);
      class_define_index(ppt->index_tp_delta_gsf2,  ppt->has_source_delta_gsf2, index_type,1);
      ...
      class_define_index(ppt->index_tp_theta_gsf,  ppt->has_source_theta_gsf, index_type,1);
      class_define_index(ppt->index_tp_theta_gsf2,  ppt->has_source_theta_gsf2, index_type,1);
...
int perturbations_prepare_k_output(struct background * pba,
  ...
  if (ppt->k_output_values_num > 0) {
    ...
    if (ppt->has_scalars == _TRUE_){
      ...
      /* Scalar field gsf */
      class_store_columntitle(ppt->scalar_titles, "delta_gsf", pba->has_gsf);
      class_store_columntitle(ppt->scalar_titles, "theta_gsf", pba->has_gsf);
      class_store_columntitle(ppt->scalar_titles, "delta_gsf2", pba->has_gsf2);
      class_store_columntitle(ppt->scalar_titles, "theta_gsf2", pba->has_gsf2);
      /** Fluid */
...
int perturbations_vector_init(
  ...
  if (_scalars_) {
    ...
    class_define_index(ppv->index_pt_phi_gsf,pba->has_gsf,index_pt,1); /* scalar field density */
    class_define_index(ppv->index_pt_phi_prime_gsf,pba->has_gsf,index_pt,1); /* scalar field velocity */
    class_define_index(ppv->index_pt_phi_gsf2,pba->has_gsf2,index_pt,1); /* scalar field density */
    class_define_index(ppv->index_pt_phi_prime_gsf2,pba->has_gsf2,index_pt,1); /* scalar field velocity */
  ...
  /** - case of switching approximation while a wavenumber is being integrated */
    ...
    if (_scalars_) {
      ...
      if (pba->has_gsf == _TRUE_) {
        ...
        ppv->y[ppv->index_pt_phi_gsf] =
          ppw->pv->y[ppw->pv->index_pt_phi_gsf];

        ppv->y[ppv->index_pt_phi_prime_gsf] =
          ppw->pv->y[ppw->pv->index_pt_phi_prime_gsf];
      }

      if (pba->has_gsf2 == _TRUE_) {

        ppv->y[ppv->index_pt_phi_gsf2] =
          ppw->pv->y[ppw->pv->index_pt_phi_gsf2];

        ppv->y[ppv->index_pt_phi_prime_gsf2] =
          ppw->pv->y[ppw->pv->index_pt_phi_prime_gsf2];
      }
    ...
    */
    ...
    if ((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad)) {
      ...
      if (pba->has_gsf == _TRUE_) {
        ...
        ppw->pv->y[ppw->pv->index_pt_phi_gsf] = 0.;
        /*  a*a/k/k/ppw->pvecback[pba->index_bg_phi_prime_gsf]*k*ktau_three/4.*1./(4.-6.*(1./3.)+3.*1.) * (ppw->pvecback[pba->index_bg_rho_gsf] + ppw->pvecback[pba->index_bg_p_gsf])* ppr->curvature_ini * s2_squared; */

        ppw->pv->y[ppw->pv->index_pt_phi_prime_gsf] = 0.;
        /* delta_fld expression * rho_gsf with the w = 1/3, c_s = 1
           a*a/ppw->pvecback[pba->index_bg_phi_prime_gsf]*( - ktau_two/4.*(1.+1./3.)*(4.-3.*1.)/(4.-6.*(1/3.)+3.*1.)*ppw->pvecback[pba->index_bg_rho_gsf] - ppw->pvecback[pba->index_bg_dV_gsf]*ppw->pv->y[ppw->pv->index_pt_phi_gsf])* ppr->curvature_ini * s2_squared; */
      }

      if (pba->has_gsf2 == _TRUE_) {

        ppw->pv->y[ppw->pv->index_pt_phi_gsf2] = 0.;

        ppw->pv->y[ppw->pv->index_pt_phi_prime_gsf2] = 0.;
      }
    ...
    if (ppt->gauge == newtonian) {
      ...
      */
      ...
      if (pba->has_gsf == _TRUE_) {
        ...
        // ppw->pv->y[ppw->pv->index_pt_phi_gsf] += alpha*ppw->pvecback[pba->index_bg_phi_prime_gsf];
        // ppw->pv->y[ppw->pv->index_pt_phi_prime_gsf] +=
        //   (-2.*a_prime_over_a*alpha*ppw->pvecback[pba->index_bg_phi_prime_gsf]
        //    -a*a* dV_gsf(pba,ppw->pvecback[pba->index_bg_phi_gsf])*alpha
        //    +ppw->pvecback[pba->index_bg_phi_prime_gsf]*alpha_prime);
        printf("Asked for kessence scalar field AND Newtonian gauge. Not yet implemented");
      }
...
int perturbations_total_stress_energy(
  ...
  double delta_rho_gsf, delta_p_gsf, delta_rho_gsf2, delta_p_gsf2,psi;
  ...
  if (_scalars_) {
    ...
    /* scalar field contribution.
       In Newtonian gauge, delta_gsf depends on the metric perturbation psi which is inferred
    ...
    */
    ...
    double P = ppw->pvecback[pba->index_bg_P_gsf];
    double PX = ppw->pvecback[pba->index_bg_PX_gsf];
    double Pphi=ppw->pvecback[pba->index_bg_Pphi_gsf];
    double PXX = ppw->pvecback[pba->index_bg_PXX_gsf];
    double PXphi = ppw->pvecback[pba->index_bg_PXphi_gsf] ;
    double Pphiphi = ppw->pvecback[pba->index_bg_Pphiphi_gsf] ;
    double PXXX = ppw->pvecback[pba->index_bg_PXXX_gsf];
    double PXXphi = ppw->pvecback[pba->index_bg_PXXphi_gsf] ;
    double PXphiphi = ppw->pvecback[pba->index_bg_PXphiphi_gsf] ;
    double phi_prime= ppw->pvecback[pba->index_bg_phi_prime_gsf];
    double delta_phi = y[ppw->pv->index_pt_phi_gsf];
    double delta_phi_prime= y[ppw->pv->index_pt_phi_prime_gsf];
    double delta_X= phi_prime*delta_phi_prime/a2;
    double X = pow(ppw->pvecback[pba->index_bg_phi_prime_gsf],2)/2/a2;



      if (ppt->gauge == synchronous){
        // delta_rho_gsf =  1./3.*
        //   (1./a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_prime_gsf]
        //    + ppw->pvecback[pba->index_bg_dV_gsf]*y[ppw->pv->index_pt_phi_gsf]);
        // delta_p_gsf = 1./3.*
        //   (1./a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_prime_gsf]
        //    - ppw->pvecback[pba->index_bg_dV_gsf]*y[ppw->pv->index_pt_phi_gsf]);

        delta_p_gsf = 1./3.*(PX*delta_X + Pphi*delta_phi) ;
        delta_rho_gsf = 1./3.*(PX*delta_X - Pphi*delta_phi + 2*X*PXX*delta_X + 2*X*PXphi*delta_phi); 
    ...
    //       (1./a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_prime_gsf]
    //        + ppw->pvecback[pba->index_bg_dV_gsf]*y[ppw->pv->index_pt_phi_gsf]
    //        - 1./a2*pow(ppw->pvecback[pba->index_bg_phi_prime_gsf],2)*psi);
    //     delta_p_gsf =  1./3.*
    //       (1./a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_prime_gsf]
    //        - ppw->pvecback[pba->index_bg_dV_gsf]*y[ppw->pv->index_pt_phi_gsf]
    //        - 1./a2*pow(ppw->pvecback[pba->index_bg_phi_prime_gsf],2)*psi);
    //   }
      ...
      ppw->delta_rho += delta_rho_gsf;

      // ppw->rho_plus_p_theta +=  1./3.*
      //   k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_gsf];
      ppw->rho_plus_p_theta += 1./3. * (PX*k*k/a2*phi_prime*delta_phi);




      ppw->delta_p += delta_p_gsf;

      ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_gsf]+ppw->pvecback[pba->index_bg_p_gsf];
    ...
    class_test(ppt->gauge == newtonian,
               ppt->error_message,
               "Asked for scalar modified gravity AND Newtonian gauge. Not yet implemented");
    double P = ppw->pvecback[pba->index_bg_P_gsf2];
    double PX = ppw->pvecback[pba->index_bg_PX_gsf2];
    double Pphi=ppw->pvecback[pba->index_bg_Pphi_gsf2];
    double PXX = ppw->pvecback[pba->index_bg_PXX_gsf2];
    double PXphi = ppw->pvecback[pba->index_bg_PXphi_gsf2] ;
    double Pphiphi = ppw->pvecback[pba->index_bg_Pphiphi_gsf2] ;
    double PXXX = ppw->pvecback[pba->index_bg_PXXX_gsf2];
    double PXXphi = ppw->pvecback[pba->index_bg_PXXphi_gsf2] ;
    double PXphiphi = ppw->pvecback[pba->index_bg_PXphiphi_gsf2] ;
    double phi_prime= ppw->pvecback[pba->index_bg_phi_prime_gsf2];
    double delta_phi = y[ppw->pv->index_pt_phi_gsf2];
    double delta_phi_prime= y[ppw->pv->index_pt_phi_prime_gsf2];
    double delta_X= phi_prime*delta_phi_prime/a2;
    double X = pow(ppw->pvecback[pba->index_bg_phi_prime_gsf2],2)/2/a2;



      if (ppt->gauge == synchronous){
 
        delta_p_gsf2 = 1./3.*(PX*delta_X + Pphi*delta_phi) ;
        delta_rho_gsf2 = 1./3.*(PX*delta_X - Pphi*delta_phi + 2*X*PXX*delta_X + 2*X*PXphi*delta_phi); 

      }
      ppw->delta_rho += delta_rho_gsf2;
      ppw->rho_plus_p_theta += 1./3. * (PX*k*k/a2*phi_prime*delta_phi);
      ppw->delta_p += delta_p_gsf2;
      ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_gsf2]+ppw->pvecback[pba->index_bg_p_gsf2];
...
int perturbations_sources(
  ...
  double delta_g, delta_rho_gsf, rho_plus_p_theta_gsf, delta_rho_gsf2, rho_plus_p_theta_gsf2;
  ...
  if (_scalars_) {
    ...
    /* delta_gsf */
     if (ppt->has_source_delta_gsf == _TRUE_) {
      if (ppt->gauge == synchronous){
      //   delta_rho_gsf =  1./3.*
      //     (1./a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_prime_gsf]
      //      + ppw->pvecback[pba->index_bg_dV_gsf]*y[ppw->pv->index_pt_phi_gsf])
      //     + 3.*a_prime_over_a*(1.+pvecback[pba->index_bg_p_gsf]/pvecback[pba->index_bg_rho_gsf])*theta_over_k2; // N-body gauge correction
      // }
    double P = ppw->pvecback[pba->index_bg_P_gsf];
    double PX = ppw->pvecback[pba->index_bg_PX_gsf];
    double Pphi=ppw->pvecback[pba->index_bg_Pphi_gsf];
    ...
    delta_rho_gsf = 1./3.*(PX*delta_X - Pphi*delta_phi + 2*X*PXX*delta_X + 2*X*PXphi*delta_phi); 
    //no N-Body gauge correction term included, since I'm not sure if it's the same in the cononical case (although I would guess so), so can't use N-body for now.
    }
        ...
        //   (1./a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_prime_gsf]
        //    + ppw->pvecback[pba->index_bg_dV_gsf]*y[ppw->pv->index_pt_phi_gsf]
        //    - 1./a2*pow(ppw->pvecback[pba->index_bg_phi_prime_gsf],2)*ppw->pvecmetric[ppw->index_mt_psi])
        //   + 3.*a_prime_over_a*(1.+pvecback[pba->index_bg_p_gsf]/pvecback[pba->index_bg_rho_gsf])*theta_over_k2; // N-body gauge correction
        printf("Asked for scalar modified gravity AND Newtonian gauge. Not yet implemented");

      }
      _set_source_(ppt->index_tp_delta_gsf) = delta_rho_gsf/pvecback[pba->index_bg_rho_gsf];
    }

    if (ppt->has_source_delta_gsf2 == _TRUE_) {
      if (ppt->gauge == synchronous){
    ...
    //no N-Body gauge correction term included, since I'm not sure if it's the same in the cononical case (although I would guess so), so can't use N-body for now.
      ...
      _set_source_(ppt->index_tp_delta_gsf2) = delta_rho_gsf2/pvecback[pba->index_bg_rho_gsf2];
    }
    ...
    /* theta_gsf */
    if (ppt->has_source_theta_gsf == _TRUE_) {

      rho_plus_p_theta_gsf = 1./3.*
        k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_gsf];

      _set_source_(ppt->index_tp_theta_gsf) = rho_plus_p_theta_gsf/(pvecback[pba->index_bg_rho_gsf]+pvecback[pba->index_bg_p_gsf])
        + theta_shift; // N-body gauge correction
    }

    if (ppt->has_source_theta_gsf2 == _TRUE_) {

      rho_plus_p_theta_gsf2 = 1./3.*
        k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_gsf2]*y[ppw->pv->index_pt_phi_gsf2];

      _set_source_(ppt->index_tp_theta_gsf2) = rho_plus_p_theta_gsf2/(pvecback[pba->index_bg_rho_gsf2]+pvecback[pba->index_bg_p_gsf2])
        + theta_shift; // N-body gauge correction
    }
...
int perturbations_print_variables(double tau,
  ...
  double delta_rho_gsf=0., rho_plus_p_theta_gsf=0.;
  double delta_gsf=0., theta_gsf=0.;
  double delta_rho_gsf2=0., rho_plus_p_theta_gsf2=0.;
  double delta_gsf2=0., theta_gsf2=0.;
  /** - ncdm sector begins */
  int n_ncdm;
  ...
  if (_scalars_) {
    ...
    delta_rho_gsf = 1./3.*(PX*delta_X - Pphi*delta_phi + 2*X*PXX*delta_X + 2*X*PXphi*delta_phi); 
      ...
      // rho_plus_p_theta_gsf =  1./3.*
      //   k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_gsf];
      rho_plus_p_theta_gsf = 1/3 *ppw->pvecback[pba->index_bg_PX_gsf]*k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_gsf]*y[ppw->pv->index_pt_phi_gsf];


      delta_gsf = delta_rho_gsf/pvecback[pba->index_bg_rho_gsf];
      theta_gsf = rho_plus_p_theta_gsf/(pvecback[pba->index_bg_rho_gsf]+pvecback[pba->index_bg_p_gsf]);
    ...
    delta_rho_gsf2 = 1./3.*(PX*delta_X - Pphi*delta_phi + 2*X*PXX*delta_X + 2*X*PXphi*delta_phi); 
      ...
      rho_plus_p_theta_gsf2 = 1/3 *ppw->pvecback[pba->index_bg_PX_gsf2]*k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_gsf2]*y[ppw->pv->index_pt_phi_gsf2];


      delta_gsf2 = delta_rho_gsf2/pvecback[pba->index_bg_rho_gsf2];
      theta_gsf2 = rho_plus_p_theta_gsf2/(pvecback[pba->index_bg_rho_gsf2]+pvecback[pba->index_bg_p_gsf2]);
    ...
    if (ppt->gauge == synchronous) {
      ...
      if (pba->has_gsf == _TRUE_) {
        delta_gsf += alpha*(-3.0*H*(1.0+pvecback[pba->index_bg_p_gsf]/pvecback[pba->index_bg_rho_gsf]));
        theta_gsf += k*k*alpha;
      }

      if (pba->has_gsf2 == _TRUE_) {
        delta_gsf2 += alpha*(-3.0*H*(1.0+pvecback[pba->index_bg_p_gsf2]/pvecback[pba->index_bg_rho_gsf2]));
        theta_gsf2 += k*k*alpha;
      }
    ...
    /* Scalar field gsf*/
    class_store_double(dataptr, delta_gsf, pba->has_gsf, storeidx);
    class_store_double(dataptr, theta_gsf, pba->has_gsf, storeidx);
    class_store_double(dataptr, delta_gsf2, pba->has_gsf2, storeidx);
    class_store_double(dataptr, theta_gsf2, pba->has_gsf2, storeidx);
    /** Fluid */
...
int perturbations_derivs(double tau,
  ...
  if (_scalars_) {
    ...
    if (pba->has_gsf == _TRUE_) {
      ...
      dy[pv->index_pt_phi_gsf] = y[pv->index_pt_phi_prime_gsf];

      /** - ----> Klein Gordon equation */

      // dy[pv->index_pt_phi_prime_gsf] =  - 2.*a_prime_over_a*y[pv->index_pt_phi_prime_gsf]
      //   - metric_continuity*pvecback[pba->index_bg_phi_prime_gsf] //  metric_continuity = h'/2
      //   - (k2 + a2*pvecback[pba->index_bg_ddV_gsf])*y[pv->index_pt_phi_gsf]; //checked
    ...
    double PXphiphi = ppw->pvecback[pba->index_bg_PXphiphi_gsf] ;
    double phi_prime= ppw->pvecback[pba->index_bg_phi_prime_gsf];
    double phi_prime_square = pow(phi_prime,2);
    double delta_phi = y[ppw->pv->index_pt_phi_gsf];
    double delta_phi_prime= y[ppw->pv->index_pt_phi_prime_gsf];
    double delta_X= phi_prime*delta_phi_prime/a2;
    double X = pow(ppw->pvecback[pba->index_bg_phi_prime_gsf],2)/2/a2;
    double curlyH = a_prime_over_a;
    // double phi_prime_prime = - (2*curlyH*phi_prime + (PXphi - curlyH * phi_prime/a2)*pow(phi_prime,2) - a2*Pphi   ) / (PX + PXX*phi_prime*phi_prime/a2);
    double phi_prime_prime = ppw->pvecback[pba->index_bg_phi_prime_prime_gsf];
    double X_prime = (phi_prime*phi_prime_prime-curlyH*phi_prime*phi_prime)/a2;

    double A = PXX*phi_prime*phi_prime/a2 + PX;
    double B = 2*curlyH*PX + PXXX * X_prime*phi_prime_square/2 + PXXphi*phi_prime_square*phi_prime/a2 + PXX*( 3*phi_prime*phi_prime_prime/a2 - curlyH*phi_prime_square/a2 ) + PXphi*phi_prime ;
    double C = -a2*Pphi + PX*k2 + PXXphi*X_prime*phi_prime + PXphi*phi_prime_prime + PXphiphi*phi_prime_square + 2*curlyH*PXphi*phi_prime;
    double D = metric_continuity*PX*phi_prime; //metric_continuity = h'/2 = 3H_L




    dy[pv->index_pt_phi_prime_gsf] = -(B*delta_phi_prime + C*delta_phi +D )/A;
    }
    ...
    if (pba->has_gsf2 == _TRUE_) {
      ...
      dy[pv->index_pt_phi_gsf2] = y[pv->index_pt_phi_prime_gsf2];
    ...
    double curlyH = a_prime_over_a;
    // double phi_prime_prime = - (2*curlyH*phi_prime + (PXphi - curlyH * phi_prime/a2)*pow(phi_prime,2) - a2*Pphi   ) / (PX + PXX*phi_prime*phi_prime/a2);
    double phi_prime_prime = ppw->pvecback[pba->index_bg_phi_prime_prime_gsf2];
    double X_prime = (phi_prime*phi_prime_prime-curlyH*phi_prime*phi_prime)/a2;
    ...
    dy[pv->index_pt_phi_prime_gsf2] = -(B*delta_phi_prime + C*delta_phi +D )/A;
